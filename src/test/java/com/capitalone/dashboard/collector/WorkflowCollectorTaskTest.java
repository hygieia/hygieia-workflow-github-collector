...
import com.capitalone.dashboard.model.GitWorkflowRunJobStep;
...
public class WorkflowCollectorTaskTest {
	...
	@Mock private WorkflowRunRepository<GitWorkflowRun> workflowRunRepository;
	@Mock private WorkflowRunJobRepository<GitWorkflowRunJob> workflowRunJobRepository;
	@Mock private GitHub repo1;
    @Mock private GitHub repo2;
    @Mock private WorkflowClient workflowClient;
    
    @Mock private GitWorkflowSettings gitHubSettings;
	...
	private List<GitWorkflowRun> getWorkflowRuns() {
		ArrayList<GitWorkflowRun> wfrs = new ArrayList<GitWorkflowRun>();
		GitWorkflowRun wfr1 = new GitWorkflowRun("8675309","001","completed","success","build","created_at","updated_at");
		wfrs.add(wfr1);
		GitWorkflowRun wfr2 = new GitWorkflowRun("8675309","002","queued","neutral","build","created_at","updated_at");
		wfrs.add(wfr2);
		return wfrs;
	}
	
	private List<GitWorkflowRunJob> getWorkflowRunJob1() {
		ArrayList<GitWorkflowRunJob> wfrjs = new ArrayList<GitWorkflowRunJob>();
		GitWorkflowRunJob wfrj1 = new GitWorkflowRunJob("8675309","001","001","completed","success","build","created_at","updated_at");
		ArrayList<GitWorkflowRunJobStep> wfrjss = new ArrayList<GitWorkflowRunJobStep>();
		GitWorkflowRunJobStep wfrjs1 = new GitWorkflowRunJobStep("8675309","001","001","001","completed",
				"success","created_at","updated_at","step-1");
		wfrjss.add(wfrjs1);
		GitWorkflowRunJobStep wfrjs2 = new GitWorkflowRunJobStep("8675309","001","001","002","completed",
	...
	private List<GitWorkflowRunJob> getWorkflowRunJob2() {
		ArrayList<GitWorkflowRunJob> wfrjs = new ArrayList<GitWorkflowRunJob>();
		GitWorkflowRunJob wfrj1 = new GitWorkflowRunJob("8675309","002","001","completed","success","build","created_at","updated_at");
		ArrayList<GitWorkflowRunJobStep> wfrjss = new ArrayList<GitWorkflowRunJobStep>();
		GitWorkflowRunJobStep wfrjs1 = new GitWorkflowRunJobStep("8675309","002","001","001","completed",
				"success","created_at","updated_at","step-1");
		wfrjss.add(wfrjs1);
		GitWorkflowRunJobStep wfrjs2 = new GitWorkflowRunJobStep("8675309","002","001","002","completed",
				"success","created_at","updated_at","step-2");
		wfrjss.add(wfrjs2);
		wfrj1.setWorkflowRunJobSteps(wfrjss);
		wfrjs.add(wfrj1);
